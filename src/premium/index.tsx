...
const _glassnoteApiPromo = import.meta.glob<any>(
  '../../premium/src/GlassnoteApiPromoToaster.tsx',
  { eager: true }
);
...
export const GlassnoteApiPromoToaster: React.FC<any> =
  get(_glassnoteApiPromo, 'GlassnoteApiPromoToaster', NullComponent);
