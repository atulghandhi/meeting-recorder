...
interface SidebarProps {
    activeTab: 'general' | 'glassnote-api' | 'ai-providers' | 'about';
    setActiveTab: (tab: 'general' | 'glassnote-api' | 'ai-providers' | 'about') => void;
    onClose: () => void;
}
        ...
        <div className="w-64 bg-bg-sidebar flex flex-col border-r border-border-subtle h-full">
            <div className="p-6">
                ...
                <nav className="space-y-1">
                    ...
                    >
                        <GlassnoteLogoMark size={16} className="text-blue-500" /> Glassnote API
                    </button>
                    <button
