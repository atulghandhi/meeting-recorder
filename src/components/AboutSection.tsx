...
export const AboutSection: React.FC<AboutSectionProps> = () => {
    ...
    return (
        <div className="space-y-6 animated fadeIn pb-10">
            {/* Header */}
            <div>
                <h3 className="text-lg font-bold text-text-primary mb-1">About Glassnote</h3>
                    ...
                    <div className="p-3 border-b border-border-subtle bg-bg-card/50">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary leading-relaxed">
                                    Glassnote now securely connects to Google Calendar and Outlook to automatically pull context and prepare for your upcoming meetings.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                <h4 className="text-xs font-bold text-text-tertiary uppercase tracking-wider mb-2 px-1">How Glassnote Works</h4>
                <div className="bg-bg-item-surface rounded-xl border border-border-subtle overflow-hidden">
                    <div className="p-3 border-b border-border-subtle bg-bg-card/50">
                        <div className="flex items-start gap-4">
                            <div className="w-10 h-10 rounded-lg bg-blue-500/10 flex items-center justify-center text-blue-400 shrink-0">
                    ...
                    <div className="p-3 bg-bg-card/50">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary leading-relaxed">
                                    A purely local vector memory system allows Glassnote to recall details from past meetings. Embeddings and retrieval happen on-device via SQLite for maximum privacy.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-text-secondary mt-1 leading-relaxed">
                                Glassnote listens only when active. It does not record video, take arbitrary screenshots without command, or perform background surveillance.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <a
                            href="https://glassnote.software"
                            onClick={(e) => handleOpenLink(e, "https://glassnote.software")}
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="pt-0.5">
                                    ...
                                    <p className="text-xs text-text-secondary leading-relaxed max-w-lg">
                                        ...
                                        <br />
                                        <span className="font-bold text-text-primary">Glassnote</span> is made to feel fast, quiet, and respectful of your privacy.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 pl-[60px]">
                                <a
                                    href="https://github.com/Glassnote-AI-assistant/glassnote-cluely-ai-assistant"
                                    onClick={(e) => handleOpenLink(e, "https://github.com/Glassnote-AI-assistant/glassnote-cluely-ai-assistant")}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary mt-0.5">Love Glassnote? Support us by starring the repo.</p>
                            </div>
                        </a>

                        <a
                            href="https://github.com/Glassnote-AI-assistant/glassnote-cluely-ai-assistant/issues"
                            onClick={(e) => handleOpenLink(e, "https://github.com/Glassnote-AI-assistant/glassnote-cluely-ai-assistant/issues")}
                            className="bg-bg-item-surface border border-border-subtle rounded-xl p-5 transition-all group flex items-center gap-4 h-full hover:bg-white/10"
                        >
                    ...
                    <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary mt-0.5">Glassnote is independent open-source software.</p>
                            </div>
                        </div>
                        <a
