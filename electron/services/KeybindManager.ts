...
export const DEFAULT_KEYBINDS: KeybindConfig[] = [
    ...
    // having to click the Glassnote window first (regression fix for issue #233).
    ...
    // every text input system-wide while Glassnote is running.
    ...
    // type:'panel' on macOS, so focusing it does not activate the Glassnote app —
